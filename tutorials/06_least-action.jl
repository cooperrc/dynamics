...
# ╔═╡ 0d3ad9fc-8387-48c8-967c-6d55d841697f
using Plots

# ╔═╡ a5739b56-ac6c-4143-8eab-959e7fa186de
md"""# Spring-mass harmonic oscillator

## Part one - setting up numerical integration

_note: there's some numerical issues that come up_

[![Brachistochrone Numerical Integration](https://img.youtube.com/vi/Xv5swK8gwAs/0.jpg)](https://www.youtube.com/live/Xv5swK8gwAs?si=fg7udrZ6dWFtbvNH "Brachistochrone numerical integration introduction - click to watch")

## Part two - getting numerical integration up and running

_note: ironed out some numerical issues with some hacks_

[![Numerical Integration - Brachistochrone and Least Action](https://img.youtube.com/vi/fYugvp9jIUY/0.jpg)](https://www.youtube.com/live/fYugvp9jIUY?si=fg7udrZ6dWFtbvNH "Numerical Integration - Brachistochrone and Least Action - click to watch")
...
# ╔═╡ 9f9891bd-3e56-4bbc-b060-37f4295dbf03
...
# ╔═╡ 4957d5f3-b024-49be-9ddc-634b5a6db9bd
md"""## Lagrange definition

The _Principle of least action_ states that the difference between kinetic, $T$, and potential, $V$, energy must be minimized given the forces and constraints a system. 
...
# ╔═╡ d22a447d-9440-4b85-912d-bab2e24463fe
begin
	v = sol[1,:]
	x = sol[2,:]
	T = 1/2 .* m .* v.^2
...
# ╔═╡ acf00402-0562-43b0-aa0b-f6e17f92664a
md"""## Integrating the _action_ in the system
...
According to the _principle of least action_, the number we calculate should be the minimum. 
"""

# ╔═╡ 4a057f33-8cc9-4fa6-9c1b-67fa652a6b36
function integrate_action(L, t)
	L_dt = L[1:end-1].*(t[2:end]- t[1:end-1])
	return sum(L_dt)
end

# ╔═╡ 7c3f1e47-6fbd-4121-a3c8-693b8169d58e
integrate_action(L, t)

# ╔═╡ 8b6d9fef-2686-44f5-b3dc-6dc3948f4c18
md"""## Try your own functions

Test the math behind this claim that we have found the functions of _least action_. What other functions satisfy the initial conditions?
"""

# ╔═╡ d5702edf-bae5-4d45-87e6-ec710c052e49
begin
...
# ╔═╡ 4ba5d3ac-7006-4520-bf07-618a31968e76
...
manifest_format = "2.0"
project_hash = "b76d0a2508237ebda52383f4b7bcfabc86bbe9c0"

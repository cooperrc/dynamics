...
$L = \frac{1}{2}m\left(\dot{x}^2+\frac{L^2}{3}\dot{\theta}^2 + 2L\dot{x}\dot{\theta}\cos\theta\right) - \frac{1}{2}kx^2 - mg\frac{L}{2}(1 - \cos\theta)$
...
git-tree-sha1 = "cd6b8ed059d2f9b63ce60ffd4e8e888da9e92fc4"
